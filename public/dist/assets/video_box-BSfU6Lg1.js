...
`)}`}function U(e=0){return new Promise(t=>setTimeout(t,e))}function Be(e,t){let n;return function(...r){clearTimeout(n),n=setTimeout(()=>(n=null,e.apply(this,r)),t)}}function Ve(e,t){let n=!1;return function(...r){n||(e.apply(this,r),n=!0,setTimeout(()=>{n=!1},t))}}var He=Object.freeze(Object.defineProperty({__proto__:null,ArtPlayerError:Oe,addClass:D,append:A,assToVtt:ze,capitalize:Ae,clamp:z,createElement:F,debounce:Be,def:V,download:ke,errorHandle:L,escape:je,get:Pe,getComposedPath:De,getExt:R,getIcon:Ce,getRect:I,getStyle:ye,has:H,hasClass:k,includeFromEvent:P,inverseClass:M,isBrowser:w,isIOS:he,isIOS13:ge,isInViewport:xe,isMobile:C,isSafari:S,loadImg:Ee,mergeDeep:Fe,query:T,queryAll:E,remove:_e,removeClass:O,replaceElement:Se,secondToTime:B,setStyle:j,setStyleText:we,setStyles:ve,siblings:be,sleep:U,srtToVtt:Le,supportsFlex:Te,throttle:Ve,tooltip:N,unescape:Me,userAgent:x,vttToBlob:Re},Symbol.toStringTag,{value:`Module`})),Ue=`array`,W=`boolean`,G=`string`,K=`number`,q=`object`,J=`function`;function We(e,t,n){return L(t===G||t===K||e instanceof Element,`${n.join(`.`)} require '${G}' or 'Element' type`)}var Y={html:We,disable:`?${W}`,name:`?${G}`,index:`?${K}`,style:`?${q}`,click:`?${J}`,mounted:`?${J}`,tooltip:`?${G}|${K}`,width:`?${K}`,selector:`?${Ue}`,onSelect:`?${J}`,switch:`?${W}`,onSwitch:`?${J}`,range:`?${Ue}`,onRange:`?${J}`,onChange:`?${J}`},Ge={id:G,container:We,url:G,poster:G,type:G,theme:G,lang:G,volume:K,isLive:W,muted:W,autoplay:W,autoSize:W,autoMini:W,loop:W,flip:W,playbackRate:W,aspectRatio:W,screenshot:W,setting:W,hotkey:W,pip:W,mutex:W,backdrop:W,fullscreen:W,fullscreenWeb:W,subtitleOffset:W,miniProgressBar:W,useSSR:W,playsInline:W,lock:W,gesture:W,fastForward:W,autoPlayback:W,autoOrientation:W,airplay:W,proxy:`?${J}`,plugins:[J],layers:[Y],contextmenu:[Y],settings:[Y],controls:[{...Y,position:(e,t,n)=>{let r=[`top`,`left`,`right`];return L(r.includes(e),`${n.join(`.`)} only accept ${r.toString()} as parameters`)}}],quality:[{default:`?${W}`,html:G,url:G}],highlight:[{time:K,text:G}],thumbnails:{url:G,number:K,column:K,width:K,height:K,scale:K},subtitle:{url:G,name:G,type:G,style:q,escape:W,encoding:G,onVttLoad:J},moreVideoAttr:q,i18n:q,icons:q,cssVar:q,customType:q},X=class{constructor(e){this.id=0,this.art=e,this.cache=new Map,this.add=this.add.bind(this),this.remove=this.remove.bind(this),this.update=this.update.bind(this)}get show(){return k(this.art.template.$player,`art-${this.name}-show`)}set show(e){let{$player:t}=this.art.template,n=`art-${this.name}-show`;e?D(t,n):O(t,n),this.art.emit(this.name,e)}toggle(){this.show=!this.show}add(e){let t=typeof e==`function`?e(this.art):e;if(t.html=t.html||``,v(t,Y),!this.$parent||!this.name||t.disable)return;let n=t.name||`${this.name}${this.id}`;L(!this.cache.has(n),`Can't add an existing [${n}] to the [${this.name}]`),this.id+=1;let r=F(`div`);D(r,`art-${this.name}`),D(r,`art-${this.name}-${n}`);let i=Array.from(this.$parent.children);r.dataset.index=t.index||this.id;let a=i.find(e=>Number(e.dataset.index)>=Number(r.dataset.index));a?a.insertAdjacentElement(`beforebegin`,r):A(this.$parent,r),t.html&&A(r,t.html),t.style&&ve(r,t.style),t.tooltip&&N(r,t.tooltip);let o=[];if(t.click){let e=this.art.events.proxy(r,`click`,e=>{e.preventDefault(),t.click.call(this.art,this,e)});o.push(e)}return t.selector&&[`left`,`right`].includes(t.position)&&this.selector(t,r,o),this[n]=r,this.cache.set(n,{$ref:r,events:o,option:t}),t.mounted&&t.mounted.call(this.art,r),r}remove(e){L(this.cache.has(e),`Can't find [${e}] from the [${this.name}]`);let t=this.cache.get(e);t.option.beforeUnmount&&t.option.beforeUnmount.call(this.art,t.$ref);for(let e of t.events)this.art.events.remove(e);this.cache.delete(e),delete this[e],_e(t.$ref)}update(e){if(this.cache.has(e.name)){let t=this.cache.get(e.name);e=Object.assign(t.option,e),this.remove(e.name)}return this.add(e)}};function Ke(e){return t=>{let{i18n:n,constructor:{ASPECT_RATIO:r}}=t,i=r.map(e=>`<span data-value="${e}">${e==="default"?n.get(`Default`):e}</span>`).join(``);return{...e,html:`${n.get(`Aspect Ratio`)}: ${i}`,click:(e,n)=>{let{value:r}=n.target.dataset;r&&(t.aspectRatio=r,e.show=!1)},mounted:e=>{let n=T(`[data-value="default"]`,e);n&&M(n,`art-current`),t.on(`aspectRatio`,t=>{let n=E(`span`,e).find(e=>e.dataset.value===t);n&&M(n,`art-current`)})}}}}function qe(e){return t=>({...e,html:t.i18n.get(`Close`),click:e=>{e.show=!1}})}function Je(e){return t=>{let{i18n:n,constructor:{FLIP:r}}=t,i=r.map(e=>`<span data-value="${e}">${n.get(Ae(e))}</span>`).join(``);return{...e,html:`${n.get(`Video Flip`)}: ${i}`,click:(e,n)=>{let{value:r}=n.target.dataset;r&&(t.flip=r.toLowerCase(),e.show=!1)},mounted:e=>{let n=T(`[data-value="normal"]`,e);n&&M(n,`art-current`),t.on(`flip`,t=>{let n=E(`span`,e).find(e=>e.dataset.value===t);n&&M(n,`art-current`)})}}}}function Ye(e){return t=>({...e,html:t.i18n.get(`Video Info`),click:e=>{t.info.show=!0,e.show=!1}})}function Xe(e){return t=>{let{i18n:n,constructor:{PLAYBACK_RATE:r}}=t,i=r.map(e=>`<span data-value="${e}">${e===1?n.get(`Normal`):e.toFixed(1)}</span>`).join(``);return{...e,html:`${n.get(`Play Speed`)}: ${i}`,click:(e,n)=>{let{value:r}=n.target.dataset;r&&(t.playbackRate=Number(r),e.show=!1)},mounted:e=>{let n=T(`[data-value="1"]`,e);n&&M(n,`art-current`),t.on(`video:ratechange`,()=>{let n=E(`span`,e).find(e=>Number(e.dataset.value)===t.playbackRate);n&&M(n,`art-current`)})}}}}function Ze(e){let t=w?location.href:``;return{...e,html:`<a href="https://artplayer.org?ref=${encodeURIComponent(t)}" target="_blank" style="width:100%;">ArtPlayer ${y}</a>`}}var Qe=class extends X{constructor(e){super(e),this.name=`contextmenu`,this.$parent=e.template.$contextmenu,C||this.init()}init(){let{option:e,proxy:t,template:{$player:n,$contextmenu:r}}=this.art;e.playbackRate&&this.add(Xe({name:`playbackRate`,index:10})),e.aspectRatio&&this.add(Ke({name:`aspectRatio`,index:20})),e.flip&&this.add(Je({name:`flip`,index:30})),this.add(Ye({name:`info`,index:40})),this.add(Ze({name:`version`,index:50})),this.add(qe({name:`close`,index:60}));for(let t=0;t<e.contextmenu.length;t++)this.add(e.contextmenu[t]);t(n,`contextmenu`,e=>{if(!this.art.constructor.CONTEXTMENU)return;e.preventDefault(),this.show=!0;let t=e.clientX,i=e.clientY,{height:a,width:o,left:s,top:c}=I(n),{height:l,width:u}=I(r),d=t-s,f=i-c;t+u>s+o&&(d=o-u),i+l>c+a&&(f=a-l),ve(r,{top:`${f}px`,left:`${d}px`})}),t(n,`click`,e=>{P(e,r)||(this.show=!1)}),this.art.on(`blur`,()=>{this.show=!1})}};function $e(e){return t=>({...e,tooltip:t.i18n.get(`AirPlay`),mounted:e=>{let{proxy:n,icons:r}=t;A(e,r.airplay),n(e,`click`,()=>t.airplay())}})}function et(e){return t=>({...e,tooltip:t.i18n.get(`Fullscreen`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t,a=A(e,r.fullscreenOn),o=A(e,r.fullscreenOff);j(o,`display`,`none`),n(e,`click`,()=>{t.fullscreen=!t.fullscreen}),t.on(`fullscreen`,t=>{t?(N(e,i.get(`Exit Fullscreen`)),j(a,`display`,`none`),j(o,`display`,`inline-flex`)):(N(e,i.get(`Fullscreen`)),j(a,`display`,`inline-flex`),j(o,`display`,`none`))})}})}function tt(e){return t=>({...e,tooltip:t.i18n.get(`Web Fullscreen`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t,a=A(e,r.fullscreenWebOn),o=A(e,r.fullscreenWebOff);j(o,`display`,`none`),n(e,`click`,()=>{t.fullscreenWeb=!t.fullscreenWeb}),t.on(`fullscreenWeb`,t=>{t?(N(e,i.get(`Exit Web Fullscreen`)),j(a,`display`,`none`),j(o,`display`,`inline-flex`)):(N(e,i.get(`Web Fullscreen`)),j(a,`display`,`inline-flex`),j(o,`display`,`none`))})}})}function nt(e){return t=>({...e,tooltip:t.i18n.get(`PIP Mode`),mounted:e=>{let{proxy:n,icons:r,i18n:i}=t;A(e,r.pip),n(e,`click`,()=>{t.pip=!t.pip}),t.on(`pip`,t=>{N(e,i.get(t?`Exit PIP Mode`:`PIP Mode`))})}})}function rt(e){return t=>({...e,mounted:e=>{let{proxy:n,icons:r,i18n:i}=t,a=A(e,r.play),o=A(e,r.pause);N(a,i.get(`Play`)),N(o,i.get(`Pause`)),n(a,`click`,()=>{t.play()}),n(o,`click`,()=>{t.pause()});function s(){j(a,`display`,`flex`),j(o,`display`,`none`)}function c(){j(a,`display`,`none`),j(o,`display`,`flex`)}t.playing?c():s(),t.on(`video:playing`,()=>{c()}),t.on(`video:pause`,()=>{s()})}})}function it(e,t){let{$progress:n}=e.template,{left:r}=I(n),i=z((C?t.touches[0].clientX:t.clientX)-r,0,n.clientWidth),a=i/n.clientWidth*e.duration;return{second:a,time:B(a),width:i,percentage:z(i/n.clientWidth,0,1)}}function at(e,t){if(e.isRotate){let n=t.touches[0].clientY/e.height,r=n*e.duration;e.emit(`setBar`,`played`,n,t),e.seek=r}else{let{second:n,percentage:r}=it(e,t);e.emit(`setBar`,`played`,r,t),e.seek=n}}function ot(e){return t=>{let{icons:n,option:r,proxy:i}=t,{$player:a,$progress:o}=t.template;return{...e,html:`
